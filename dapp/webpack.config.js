...
module.exports = {
  ...
  output: {
    filename: "index.js",
    path: path.join(__dirname, "dist", "dapp_assets"),
  },
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        {
          from: path.join(__dirname, "src", "dapp_assets", "assets"),
          to: path.join(__dirname, "dist", "dapp_assets"),
        },
      ],
    }),
  ...
  devServer: {
    ...
    hot: true,
    contentBase: path.resolve(__dirname, "./src/dapp_assets"),
